...
class Versioner:
    ...
    def __init__(self, project_root='.'):
        ...
        self.ml_online = dirs[0]
        self.PACKAGE = path_to_src / self.ml_online
    ...
    def commit_version(self, new_version, msg_template, tag=False):
        ...
        msg = msg_template.format(ml_online=self.ml_online,
        ...
        if tag:
            ...
            message = msg_template.format(ml_online=self.ml_online,
                                          new_version=new_version)
...
def release(project_root='.', tag=True):
    ...
    versioner.commit_version(
        bumped_version,
        msg_template='Bumps up {ml_online} to version {new_version}',
        tag=False)
